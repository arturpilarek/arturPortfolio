<template>
  <div class="text-center grid place-items-center h-[100svh] w-screen relative" data-aos="zoom-in">
    <div class="grid place-items-center">
      ...
      <h2 class="text-5xl mt-4">Artur <span class="font-chronicleDisplay text-accent">Pilarek</span></h2>
    ...
    <Icon name="ic:round-keyboard-arrow-down" class="chevron-down absolute bottom-3.5"/>
  </div>
</template>
...
<style scoped>
  ...
  .author-image {
    background-image: url("~/assets/images/author.webp") !important;
    border-color: #E66614;
  }
